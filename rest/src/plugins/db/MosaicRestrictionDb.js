...
class MosaicRestrictionDb {
	/**
	 * Creates MosaicRestrictionDb around CatapultDb.
	...
	mosaicRestrictions(mosaicId, entryType, targetAddress, options) {
		...
		return this.catapultDb.queryPagedDocumentsExt(conditions, [], sortConditions, 'mosaicRestrictions', options);
	}
...
module.exports = MosaicRestrictionDb;
