...
const toStringInternal = code => {
	switch (code) {
		...
		case 0x80590008: return 'Failure_NetworkConfig_Network_Config_Trx_Cannot_Be_Unsupported';
		...
		case 0x805A002F: return 'Failure_Service_Invalid_File_Recipient';
		case 0x805A0030: return 'Failure_Service_File_Download_Not_In_Progress';
		case 0x805F0001: return 'Failure_Operation_Plugin_Config_Malformed';
		case 0x805F0002: return 'Failure_Operation_Token_Invalid';
		case 0x805F0003: return 'Failure_Operation_Expired';
		case 0x805F0004: return 'Failure_Operation_Invalid_Duration';
		case 0x805F0005: return 'Failure_Operation_Executor_Redundant';
		case 0x805F0006: return 'Failure_Operation_Mosaic_Redundant';
		case 0x805F0007: return 'Failure_Operation_Mosaic_Invalid';
		case 0x805F0008: return 'Failure_Operation_Zero_Mosaic_Amount';
		case 0x805F0009: return 'Failure_Operation_Invalid_Mosaic_Amount';
		case 0x805F000A: return 'Failure_Operation_Invalid_Executor';
		case 0x805F000B: return 'Failure_Operation_Identify_Transaction_Misplaced';
		case 0x805F000C: return 'Failure_Operation_End_Transaction_Misplaced';
		case 0x80600001: return 'Failure_SuperContract_Super_Contract_Already_Exists';
		case 0x80600002: return 'Failure_SuperContract_Operation_Is_Not_Permitted';
		case 0x80600003: return 'Failure_SuperContract_File_Does_Not_Exist';
		case 0x80600004: return 'Failure_SuperContract_Remove_Super_Contract_File';
		case 0x80600005: return 'Failure_SuperContract_Drive_Has_Ended';
		case 0x80600006: return 'Failure_SuperContract_SuperContract_Does_Not_Exist';
		case 0x80600007: return 'Failure_SuperContract_Plugin_Config_Malformed';
		case 0x80600008: return 'Failure_SuperContract_End_Execute_Transaction_Misplaced';
		case 0x8060000B: return 'Failure_SuperContract_Execution_Count_Exceeded_Limit';
		...
		case 0x80620029: return 'Failure_Storage_Verification_Invalid_Shard_Id'
		case 0x8062002a: return 'Failure_Storage_Verification_Invalid_Prover'
		case 0x8062002b: return 'Failure_Storage_Stream_Already_Exists'
		case 0x8062002c: return 'Failure_Storage_Invalid_Stream_Id'
		case 0x8062002d: return 'Failure_Storage_Stream_Already_Finished'
		case 0x8062002e: return 'Failure_Storage_Expected_Upload_Size_Exceeded'
		case 0x8062002f: return 'Failure_Storage_Drive_Size_Excessive'
		case 0x80620030: return 'Failure_Storage_Upload_Size_Excessive'
		case 0x80620031: return 'Failure_Storage_Download_Size_Excessive'
		case 0x80620032: return 'Failure_Storage_Signature_Count_Insufficient'
		case 0x80620033: return 'Failure_Storage_Already_Applied_For_Offboarding'
		case 0x80620034: return 'Failure_Storage_Already_Initiated_Channel_Closure'
		case 0x80620035: return 'Failure_Storage_Download_Channel_Is_Finished'
		...
		case 0x80690004: return 'Failure_LiquidityProvider_Invalid_Window_Size'
		case 0x80690005: return 'Failure_LiquidityProvider_Is_Not_Registered'
		case 0x80690006: return 'Failure_LiquidityProvider_Insufficient_Currency'
		case 0x80690007: return 'Failure_LiquidityProvider_Insufficient_Mosaic'
		case 0x80690008: return 'Failure_LiquidityProvider_Invalid_Exchange_Rate'
