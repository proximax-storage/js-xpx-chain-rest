...
const toStringInternal = code => {
	switch (code) {
		...
		case 0x805F000D: return 'Failure_Operation_Identify_Transaction_Aggregated_With_End_Operation';
		...
		case 0x80600003: return 'Failure_SuperContract_File_Is_Not_Exist';
		...
		case 0x80600006: return 'Failure_SuperContract_SuperContract_Is_Not_Exist';
