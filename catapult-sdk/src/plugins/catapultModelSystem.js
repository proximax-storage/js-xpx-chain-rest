...
const plugins = {
	accountLink, accountProperties, aggregate, exchange, committee, config, contract, lock, metadata, mosaic, multisig, namespace, operation, receipts, richlist, service, supercontract, transfer, upgrade
};
